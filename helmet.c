...
GLint c,b,s1,s2,s3,s4,s5,t,u;
GLint ca=70;
GLint ba=126;
GLint rc,gc;
GLint hel=0,view=0;
GLint window,night=0;
static GLint axis=1;
...
void hbody()
{
	...
	glColor3f(0.0,0.0,0.0);
		...
		glVertex2i(195,112);
		glVertex2i(193,107);
		glVertex2i(173,97);//shoes
	glEnd();
	glBegin(GL_LINES);
	glColor3f(0.0,1.0,1.0);
		glVertex2i(183,208);
		glVertex2i(187,142);//hand
	glEnd();
	glBegin(GL_LINES);
	glColor3f(1.0,1.0,0.8);
		glVertex2i(187,142);
		glVertex2i(190,142);//hand
	glEnd();
}
void hmandraw()
{
...
{	
	...
	{
		glPushMatrix();
		glTranslated(35,55,0.0);
		glScalef(0.7,0.6,0.6);
		hmandraw();
		glPopMatrix();
		glColor3f(0.0,1.0,0.8);
		display_string(180,175," use helmet and be safe",1);
	}
	if(hel==0)
	{
		u+=15;
		glPushMatrix();
		glTranslated(225,-20+u,0.0);
		glRotatef(axis,0,0,1);
		glScalef(0.7,0.6,0.6);
		mandraw();
		glPopMatrix();
		glColor3f(1.0,0.0,0.0);
		display_string(180,175,"no helmet ! then go to hell",1);
	}
}
void display6(void)
{
...
void displaym(void)
{
	...
	glColor3f(0.0,1.0,0.0);
		display_string(400,540,"For the rider with helmet",1);
	glColor3f(1.0,0.8,0.0);
		display_string(190,540,"PRESS 'h' ",2);
	glColor3f(0.0,1.0,0.0);
		display_string(400,440,"For the rider without helmet",1);
	glColor3f(1.0,0.8,0.0);	
		display_string(190,440,"PRESS 'g' ",2);
	glColor3f(0.0,1.0,0.5);
		display_string(270,340,"PRESS SPACE for choice ",1);
	glColor3f(1.0,1.0,0.0);	
		display_string(287,240,"PRESS e for exit",1);
	glFlush();
	glutSwapBuffers();
}
...
{	
      ...
      if(key=='g') 
	{
			...
			hel=0;
			c=375;b=-150;
			s1=0;s2=0;s3=0;s4=0;s5=0;t=0;u=0;
			playSound( "hel.wav" );
			init();
			display();
	}
...
int main(int argc,char ** argv)
{
	...
	glutCreateWindow("Social awareness");
